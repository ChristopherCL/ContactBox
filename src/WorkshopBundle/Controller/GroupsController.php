...
use WorkshopBundle\Entity\Groups;
...
class GroupsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $groups = $em->getRepository('WorkshopBundle:Groups')->findAll();
    ...
    {
        $group = new Groups();
        $form = $this->createForm('WorkshopBundle\Form\GroupsType', $group);
    ...
    {
        $deleteForm = $this->createDeleteForm($group);
        $editForm = $this->createForm('WorkshopBundle\Form\GroupsType', $group);
